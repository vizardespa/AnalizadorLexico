...
namespace DC_Aplicacion
{
    class Program
    {
        ...
        {
            EjemploAnalizadorLexico();
        }

        public static void EjemploAnalizadorLexico()
        {
            AnalizadorLexicoC AnalizadorLex = new AnalizadorLexicoC();

            List<Categoria> Categorias = AnalizadorLexicoC.CargarCategorias();
            while (true)
            {
